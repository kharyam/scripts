...
APPMAP[2) 💡 On]="/home/kmendez/.local/bin/lc on"
APPMAP[3) 💡 Off]="/home/kmendez/.local/bin/lc off"
...
APPMAP[11) eDEXUI]="/home/kmendez/Projects/local/edex-ui/dist/eDEX-UI-Linux-x86_64.AppImage --no-sandbox"
APPMAP[12) Display (arandr)]="arandr"
APPMAP[13) Theme/Icons (lxappearance)]="lxappearance"
APPMAP[14) QT Theme/Icons (qt5ct)]="qt5ct"
APPMAP[15) Camera]="guvcview -d /dev/video1"
...
#APPMAP[Gittea Token]="/home/kmendez/bin/gittea"
#APPMAP[OBS]="obs"
